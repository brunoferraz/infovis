...
statesGeoJson = folium.GeoJson("./data/municipio.json")
# base = pd.read_json("./data/municipio.json", encoding='utf-8')
...
#     # bins = bins3,
# ).add_to(m)
# m.save(os.path.join('results', 'teste.html'))
...
states = statesRawData

# #REMOVE REPEATED CODES
list_codigo = states["city_ibge_code"].values
list_codigo_cleaned = []
